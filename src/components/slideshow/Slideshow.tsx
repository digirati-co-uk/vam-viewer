...
import './_SlideShowDemo.scss';

import inlineJsonExample from './inline.json';

const SlideShowDemoBase: React.FC = () => {
  // let bem = { name: 'slideshow-demo', element };
  return (
    <article className={bem}>
      ...
      <section className={bem.element('section')}>
        ...
        <p>
          The first example is the most basic version of the slideshow embedded
          into a webpage. IIIF&nbsp;Presentation&nbsp;2.1 backwards
          compatibility.
        </p>
      ...
      <section className={bem.element('section')}>
        <h2 className={bem.element('subtitle')}>Slideshow with inline json</h2>
        <p style={{ background: 'white' }}>
...
export const Slideshow = withBemClass('slideshow-demo')(SlideShowDemoBase);
